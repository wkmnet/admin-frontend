...
(function () {
    ...
    angular.module('BlurAdmin.pages.dashboard')
        .controller('dashboardColumnLineYearAmountChart', dashboardColumnLineYearAmountChart);

    /** @ngInject */
    function dashboardColumnLineYearAmountChart($scope, $http, toastr, baConfig, layoutPaths, baUtil) {
